...
s.dependency 'FBAudienceNetwork', '6.12.0' # Replace with the version you need
s.source = { :http => 'https://developers.facebook.com/resources/FBAudienceNetwork-6.12.0.zip' }
